...
tr_combined |>
  mutate(sector = case_match(sector,
    "Railways" ~ "Domestic railway",
    "Road transportation" ~ "Domestic road transport",
    .default = sector
  )) |>
  ...
  # remove 'sar china' from are names
  mutate(name = str_remove_all(name, " SAR China")) |>
...
tr_combined_percapita |>
  filter(iso3 %in% c(
    "CHN", "HKG", "MAC", "PRK", "JPN", "MNG", "KOR", "BRN", "KHM", "IDN", "LAO",
    "MYS", "MMR", "PHL", "SGP", "THA", "TLS", "VNM", "BGD", "BTN", "IND", "MDV",
    "NPL", "PAK", "LKA", "AUS", "CXR", "CCK", "NZL", "NFK")) ->
ap_figures
